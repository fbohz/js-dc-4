...
// console.log(titles)
var body = document.querySelectorAll('#article-body')
// console.log(body);
...
*/
var documentHeadings = document.querySelectorAll('h2')
console.log(documentHeadings.length);
...
for (var i = 0; i < documentHeadings.length; i++) {
  //loops cloning the headings elements
  var clone = documentHeadings[i].cloneNode(true)

  var j = 0
  //loops appending the elements to table-of-contents
  while (j < documentHeadings.length) {
    document.getElementById('table-of-contents').appendChild(clone);
    j++
  }
